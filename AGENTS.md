...
snv_indel.review.tsv          主畫面用衍生檔（自動重建；candidate BED 內 AF<0.01 / AF缺值 / ClinVar P/LP / reviewer 已標記）
snv_indel.review.tsv.source.json  衍生檔 manifest（raw mtime/size + rescue IDs + AF 門檻 + candidate BED signature）
