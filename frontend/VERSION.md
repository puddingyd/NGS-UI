...
成大醫院基因醫學部 NGS 分析平台是院內三級分析判讀工具，用來整合二級 pipeline 產出的 SNV/Indel、CNV/SV 與 Mitochondria 變異資料，協助醫師及生物資訊工程師載入個案、檢視變異卡片、標記變異、撰寫判讀意見，並輸出診斷報告。
