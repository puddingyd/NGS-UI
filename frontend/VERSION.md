...
- PGx narrative 改為基因分層顯示並依 CPIC Strong、Moderate、FDA Section 1 排序；重複 gene–drug 優先 CPIC。完整建議只列 actionable 結果，排除 normal、uncertain、standard dosing 與 no-action。
